...
import StrategicReportsPage from "../pages/dashboard/strategic-reports/page";
import DataFlowsPage from "../pages/dashboard/data-flows/page";
...
import OpsRoom from "../pages/dashboard/ops-room/page";
...
const routes: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "strategic-reports", element: <StrategicReportsPage /> },
      { path: "data-flows", element: <DataFlowsPage /> },
