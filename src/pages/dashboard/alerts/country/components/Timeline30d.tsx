    ...
    return (
      <div className="rounded-lg border border-gray-200 overflow-hidden bg-white">
        <div className="px-4 py-2.5 border-b border-gray-200 flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-sentiqs-navy">Historique — 30 jours</span>
        </div>
              ...
              <div key={date} className="relative pl-8">
                ...
                <div className="space-y-1">
                  ...
                  <span className="text-[10px] text-gray-400 ml-2">
                    {groups[date].length} incident{groups[date].length > 1 ? 's' : ''}
                  </span>
                </div>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1 flex-wrap">
                            <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-semibold ${
                              inc.verified ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-200 text-gray-500'
                            }`}>
            ...
            >
              {showAll ? (
                <>
                  ...
                  {i18n.language.startsWith('fr') ? 'Réduire (7 derniers jours)' : 'Collapse (last 7 days)'}
                </>
              ) : (
                <>
